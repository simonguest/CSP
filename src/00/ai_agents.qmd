...
Imagine a __DigiPen Campus Assistant__: An agent that can help you navigate anything and everything at DigiPen!
...
- Campus agent code: 
  - [https://github.com/simonguest/CSP-400/tree/main/demos/00/campus-agent](https://github.com/simonguest/CSP-400/tree/main/demos/00/campus-agent){.external target="_blank"}
