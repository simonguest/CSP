...
## Demo: Replicate {.center}

[https://replicate.com](https://replicate.com){.external target="_blank"}

## Demo: Calling Replicate API from Colab{.center}

[Replicate Client.ipynb](https://colab.research.google.com/drive/1WyFGPhAbUPKXAyTzWvndWSkho55XqHqw?usp=sharing){.external target="_blank"}
...
## Demo: Control via FLUX Kontext {.center}

[ControlNet Human Pose (FLUX Kontext).ipynb](https://colab.research.google.com/drive/1_y2emju5Sy4Z6TfhmZBgu3Q61DYGApdb?usp=sharing){.external target="_blank"}
...
## Demo: Putting this all together {.center}

Using text-to-image, ControlNet, inpainting, and image-to-image (depth map) to create PBR materials

[PBR Material Creator.ipynb](https://colab.research.google.com/drive/1Tn38J3u4-XJ9FQv8vSS-OUXin8hvZmrq){.external target="_blank"}
